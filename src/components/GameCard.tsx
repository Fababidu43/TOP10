      ...
      >
        ...
        <div className="flex-1 flex items-end">
          <div className="flex gap-2 w-full">
            <button 
              className="flex-1 bg-gradient-to-r from-purple-500 to-blue-500 text-white py-2 px-4 rounded-lg hover:from-purple-600 hover:to-blue-600 transition-all font-medium"
              onClick={(e) => {
                e.stopPropagation();
                onSelect(game.id);
              }}
            ...
            {game.interactive && onPlay && (
              <button 
                className="bg-gradient-to-r from-green-500 to-teal-500 text-white py-2 px-4 rounded-lg hover:from-green-600 hover:to-teal-600 transition-all font-medium flex items-center gap-2"
                onClick={(e) => {
                  e.stopPropagation();
                  onPlay(game.id);
                }}
